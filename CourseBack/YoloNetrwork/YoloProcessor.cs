...
namespace CourseBack.Models
{
    public class YoloProcessor
    {
        ...
        [ColumnName("tf_op_layer_concat_10")]
        ...
        [ColumnName("tf_op_layer_concat_11")]
        ...
        [ColumnName("tf_op_layer_concat_12")]
        ...
        public IReadOnlyList<YoloRecognitionResult> ProcessResults(string[] categories, float scoreTh = 0.5f, float iosTh = 0.5f)
        {
            ...
            List<YoloRecognitionResult> resultsNms = new List<YoloRecognitionResult>();
            ...
            while (f < postProcesssedResults.Count)
            {
                ...
                resultsNms.Add(new YoloRecognitionResult(res.Take(4).ToArray(), label, conf));
                postProcesssedResults[f] = null;

                var iou = postProcesssedResults.Select(bbox => bbox == null ? float.NaN : CalculateBoxesIou(res, bbox)).ToList();
        ...
        private static float CalculateBoxesIou(float[] boxes1, float[] boxes2)
        {
